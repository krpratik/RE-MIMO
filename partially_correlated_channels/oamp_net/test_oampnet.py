...
snrdb_list = {16:np.arange(9.0, 17.0), 32:np.arange(13.0, 21.0)}
corr_list = np.asarray([0.70, 0.80])

corr_flag = True

model_filename = './validtn_results/oampnet_corr_q' + str(mod_n) + '_' + str(NT) + '_' + str(NR) + '.pth'
oampnet_validtn_filename = './final_results/oampnet_corr_' + str(NT) + '_validtn_results.pickle'
